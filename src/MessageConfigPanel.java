...
public class MessageConfigPanel extends javax.swing.JPanel {
  ...
  public MessageConfigPanel() {
    ...
    messagesText.setTransferHandler(
    ...
    try {
      Document suggestionXML =
          DocumentBuilderFactory.newInstance()
              .newDocumentBuilder()
              .parse(this.getClass().getResource("Suggestions.xml").openStream());
      ...
      suggestionsList.setModel(
          new DefaultComboBoxModel<>(suggestions.get(groups.get(0)).toArray(new String[0])));
    } catch (IOException ex) {
  ...
  private void initComponents() {
    ...
    suggestionsCombo.addActionListener(
    ...
    messageOrderBox.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {"Display Random", "Display Sequential"}));
    messageOrderBox.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void messagesTextFocusLost(
      java.awt.event.FocusEvent evt) { // GEN-FIRST:event_messagesTextFocusLost
  ...
  private void suggestionsComboActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_suggestionsComboActionPerformed
    suggestionsList.setModel(
        new DefaultComboBoxModel<>(
            suggestions.get(suggestionsCombo.getSelectedItem()).toArray(new String[0])));
  ...
  private void messagesTextFocusGained(
      java.awt.event.FocusEvent evt) { // GEN-FIRST:event_messagesTextFocusGained
    FST.settingsChanged();
